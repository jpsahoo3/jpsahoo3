...
**Software Developer | Python, Node.js, AWS | Distributed Systems, Blockchain & Generative AI**

Backend-focused Software Developer experienced in building scalable backend systems, cloud-native services, and distributed applications. My work spans backend API development, industrial IoT platforms, blockchain infrastructure, and high-performance data-driven systems.

Currently exploring **Generative AI systems**, particularly **LLM-powered applications and Retrieval-Augmented Generation (RAG)** architectures for production-grade software systems.
